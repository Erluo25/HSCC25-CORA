function [han, xs, ys] = new_pgon_pts(pZ,varargin)
...
[han, xs, ys] = aux_plotNd(pZ,dims,NVpairs,splits);
...
function [han, xs, ys] = aux_plotNd(pZ,dims,NVpairs,splits)
    ...
    elseif length(dims) == 2 % 2d
        [han, xs, ys] = aux_plot2d(pZ,dims,NVpairs,splits);      
...
function [han, xs, ys] = aux_plot2d(pZ,dims,NVpairs,splits)
